...
/* @var $searchModel app\modules\directory\models\InsDirectoryAppformSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('messages', 'Application Form');
...
<div class="card">
    <div class="card-body">
        ...
        <hr>
        <div class="ins-directory-appform-index">

            <?php Pjax::begin(['id' =>'ins_directory_appform_pjax']); ?>
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'ins-directory-appform',
    'modal_id' => 'ins-directory-appform-modal',
    'controller' => 'ins-directory-appform',
    ...
    'modal_size' => 'modal-md',
    'grid_ajax' => 'ins_directory_appform_pjax',
