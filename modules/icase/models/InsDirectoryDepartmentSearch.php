...
/**
 * InsDirectoryDepartmentSearch represents the model behind the search form of `app\modules\icase\models\InsDirectoryDepartment`.
 */
class InsDirectoryDepartmentSearch extends InsDirectoryDepartment
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'root', 'lft', 'rgt', 'lvl', 'region_id', 'icon_type'], 'integer'],
            [['name', 'address', 'icon'], 'safe'],
    ...
    {
        $query = InsDirectoryDepartment::find();
