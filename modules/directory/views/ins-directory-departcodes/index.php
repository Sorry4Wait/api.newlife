...
/* @var $searchModel app\modules\directory\models\InsDirectoryDepartcodesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('messages', 'Department Codes');
...
<div class="card">
    <div class="card-body">
        ...
        <hr>
        <div class="ins-directory-departcodes-index">

            <?php Pjax::begin(['id' => 'ins_directory_departcodes_pjax']); ?>
                        ...
                        'buttons' => [
                            'delete' => function ($url, $model, $key) {
                                return Html::a('<span class="fa fa-trash"></span>', $url, [
                                    ...
                                    'data-method' => 'post',
                                    'data-pjax' => '1',
                                    'data-form-id' => $model->id_department,
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'ins-directory-departcodes',
    'modal_id' => 'ins-directory-departcodes-modal',
    'controller' => 'ins-directory-departcodes',
    'modal_header' => $this->title,
    'active_from_class' => 'customAjaxForm',
    'update_button' => 'update-widget',
    'create_button' => 'create-widget',
    'delete_button' => 'delete-widget',
    'modal_size' => 'modal-md',
    'grid_ajax' => 'ins_directory_departcodes_pjax',
