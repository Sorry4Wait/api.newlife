...
/* @var $searchModel app\modules\directory\models\InsDirectoryCalculationTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('messages','Type of Calculation');
...
<div class="card">
    <div class="card-body">
        ...
        <hr>
<div class="ins-directory-calculation-type-index">
    <?php Pjax::begin(['id'=>'ins_directory_calculation_pjax']); ?>
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'ins-directory-calculation-type',
    'modal_id' => 'ins-directory-calculation-type-modal',
    'controller' => 'ins-directory-calculation-type',
    'modal_header' => Yii::t('messages', 'Ins Directory Calculation Type'),
    'active_from_class' => 'customAjaxForm',
    'update_button' => 'update-widget',
    'create_button' => 'create-widget',
    'delete_button' => 'delete-widget',
    'modal_size' => 'modal-md',
    'grid_ajax' => 'ins_directory_calculation_pjax',
