...
/* @var $searchModel app\modules\directory\models\InsDirectoryPrefixSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('messages', 'Prefix of Product');
...
<div class="card">
    <div class="card-body">
        ...
        <hr>
<div class="ins-directory-prefix-index">

    <?php Pjax::begin(['id' =>'ins_directory_prefix_pjax']); ?>
    <?= GridView::widget([
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'ins-directory-prefix',
    'modal_id' => 'ins-directory-prefix-modal',
    'controller' => 'ins-directory-prefix',
    ...
    'modal_size' => 'modal-md',
    'grid_ajax' => 'ins_directory_prefix_pjax',
