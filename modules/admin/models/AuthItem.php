...
class AuthItem extends \yii\db\ActiveRecord
{
            ...
            ['name', function ($attribute, $params, $validator) {
                if($this->type == 2){
                    if (!strpos($this->$attribute,'/')) {
                        $this->addError($attribute, Yii::t('messages','In name must be symbol "/" '));
                    }
                }
                if($this->type == 1){
                    if (strpos($this->$attribute,'/')) {
                        $this->addError($attribute, Yii::t('messages','In name cannot be symbol "/" '));
                    }
                }

            }],
            [['type', 'created_at', 'updated_at'], 'integer'],
            [['description_uz', 'description_ru','description','data'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'description_uz' => Yii::t('messages', 'Description_UZ'),
            'description_ru' => Yii::t('messages', 'Description_RU'),
