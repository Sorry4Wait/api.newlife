...
$this->title = Yii::t('messages', 'Roles');
    ...
    <div class="card-body">
        <div class="card-header row">
            ...
            <div class="col col-sm-8 float-md-right">
                <?= Html::a(Yii::t('messages', 'Add New') . '<span class="btn-icon-right"><i class="fa fa-plus-circle"></i></span>', ['create'], ['class' => 'btn  mb-1 gradient-1 btn-rounded float-right create-auth-item', 'id' => 'productButton']) ?>
            </div>
        </div>
        <hr>
