...
/**
 * InsDirectoryProductKindSearch represents the model behind the search form of `app\modules\directory\models\InsDirectoryProductKind`.
 */
class InsDirectoryProductKindSearch extends InsDirectoryProductKind
{
    /**
     * {@inheritdoc}
     */
