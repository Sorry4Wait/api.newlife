...
/**
 * InsClassificationSearch represents the model behind the search form of `app\modules\icase\models\InsClassification`.
 */
class InsClassificationSearch extends InsClassification
{
    /**
     * {@inheritdoc}
     */
