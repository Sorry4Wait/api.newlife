...
/**
 * This is the model class for table "ins_directory_department".
 *
 * @property int $id
 * @property int $root
 * @property int $lft
 ...
 */
class InsDirectoryDepartment extends Tree
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'ins_directory_department';
    }
    ...
    public function rules()
    {
             ...
             return [
                 ...
                 [['name', 'address','name_ru'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'region_id' => Yii::t('messages', 'Region ID'),
    ...
    {
         $regions = InsDirectoryRegions::find()->all();
         ArrayHelper::map($regions,'id','name');
         return ['1' => 'Tashkent','2' => 'Samarqand'];
    }
}
