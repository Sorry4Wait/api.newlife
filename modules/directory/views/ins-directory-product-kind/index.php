...
/* @var $searchModel app\modules\directory\models\InsDirectoryProductKindSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('messages', 'Kind of Product');
...
<div class="card">
    <div class="card-body">
        ...
        <hr>
        <div class="ins-directory-product-kind-index">

            <?php Pjax::begin(['id' =>'ins_directory_product_kind_pjax']); ?>
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    'model' => 'ins-directory-product-kind',
    'modal_id' => 'ins-directory-product-kind-modal',
    'controller' => 'ins-directory-product-kind',
    'modal_header' => Yii::t('messages', 'Kind of Product'),
    'active_from_class' => 'customAjaxForm',
    'update_button' => 'update-widget',
    'create_button' => 'create-widget',
    'delete_button' => 'delete-widget',
    'modal_size' => 'modal-md',
    'grid_ajax' => 'ins_directory_product_kind_pjax',
