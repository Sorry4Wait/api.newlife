...
/**
 * InsDirectoryAppformSearch represents the model behind the search form of `app\modules\directory\models\InsDirectoryAppform`.
 */
class InsDirectoryAppformSearch extends InsDirectoryAppform
{
    /**
     * {@inheritdoc}
     */
