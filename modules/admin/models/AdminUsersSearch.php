...
/**
 * AdminUsersSearch represents the model behind the search form of `app\modules\admin\models\AdminUsers`.
 */
class AdminUsersSearch extends AdminUsers
{
    ...
    {
        return [
            [['id', 'current_position_id', 'department_id', 'status', 'employee_id'], 'integer'],
            [['login', 'password', 'first_name', 'last_name', 'last_login_date', 'create_date'], 'safe'],
        ];
    }
